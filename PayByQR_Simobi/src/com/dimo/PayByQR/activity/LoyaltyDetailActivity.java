...
public class LoyaltyDetailActivity extends DIMOBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(null != json) {
            ...
            try {
                JSONObject loyaltyData = new JSONObject(json);
                if(!loyaltyData.has("isMaxRedeemDaily")){
                    mLoyaltyData.isMaxRedeemDaily = true;
                }
            ...
            mLoyaltyData.maxRedeem = invoiceStatusResponse.fidelitizInfo.maxRedeem;
            mLoyaltyData.isMaxRedeemDaily = invoiceStatusResponse.fidelitizInfo.isMaxRedeemDaily;
    ...
    public void initDiscountLayout(){
        ...
        TextView txtInfoMaxRedeem = (TextView) findViewById(R.id.activity_loyalty_detail_discount_info_max_redeem);
        ...
        String mInfoExpired = "", mInfoMinimum = "", mInfoMaxDiscount = "", mInfoMaxRedeem = "";
        if(mLoyaltyData.startDate > 0 && mLoyaltyData.endDate > 0)
            ...
            mInfoExpired = getString(R.string.text_loyalty_detail_info_empty, getString(R.string.text_masa_berlaku));
        ...
        if(mLoyaltyData.minTransAmountForDiscount > 0)
            ...
            mInfoMinimum = getString(R.string.text_loyalty_detail_info_empty, getString(R.string.text_min_pembelian));
        ...
        if(mLoyaltyData.maxDiscountAmount > 0)
            ...
            mInfoMaxDiscount = getString(R.string.text_loyalty_detail_info_empty, getString(R.string.text_max_diskon));
        txtInfoMaxDiscount.setText(mInfoMaxDiscount);

        if(mLoyaltyData.maxRedeem > 0) {
            mInfoMaxRedeem = mLoyaltyData.maxRedeem+"x ";
            if(mLoyaltyData.isMaxRedeemDaily)
                mInfoMaxRedeem = mInfoMaxRedeem + getString(R.string.text_per_day);
            else
                mInfoMaxRedeem = mInfoMaxRedeem + getString(R.string.text_per_event);
        } else
            mInfoMaxRedeem = getString(R.string.text_loyalty_detail_info_empty, getString(R.string.text_max_redeem));
        txtInfoMaxRedeem.setText(mInfoMaxRedeem);
    ...
    public void initPointLayout(){
        ...
        TextView txtMaxRedeem = (TextView) findViewById(R.id.activity_loyalty_detail_point_info_max_redeem);
        ...
        //build String for Max Redeem
        String mInfoMaxRedeem = "";
        if(mLoyaltyData.maxRedeem > 0) {
            mInfoMaxRedeem = mLoyaltyData.maxRedeem+"x ";
            if(mLoyaltyData.isMaxRedeemDaily)
                mInfoMaxRedeem = mInfoMaxRedeem + getString(R.string.text_per_day);
            ...
            mInfoMaxRedeem = getString(R.string.text_loyalty_detail_info_empty, getString(R.string.text_max_redeem));
        txtMaxRedeem.setText(mInfoMaxRedeem);
