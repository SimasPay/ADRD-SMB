        ...
        try {
            if(null != response) {
                ...
                if (object.has("result") && object.getString("result").equals("success")) {
                    ...
                    if(detail.has("currentLoyaltyProgram")){
                        JSONObject currentLoyaltyProgram = detail.getJSONObject("currentLoyaltyProgram");
                        if(currentLoyaltyProgram.has("loyaltyProgram")){
                            JSONObject loyaltyProgram = currentLoyaltyProgram.getJSONObject("loyaltyProgram");
                            if(!loyaltyProgram.has("isMaxRedeemDaily")){
