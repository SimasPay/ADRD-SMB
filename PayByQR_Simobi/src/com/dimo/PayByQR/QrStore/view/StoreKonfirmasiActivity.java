...
public class StoreKonfirmasiActivity  extends DIMOBaseActivity {
    ...
    private void initActivity() {
        ...
        if(arFromCheckout[5].equals(StoreCheckout2.PICKUP_METHODE_STORE)) {
    ...
    private void reqCheckout() {
        String srtCity = "";
        if(arFromCheckout[5].equals(StoreCheckout2.PICKUP_METHODE_ADDR)) {
            ...
            if(PayByQRProperties.isPolling() && !checkPaymentThread.isPollingRun()){
                ...
                if (PayByQRProperties.isUsingCustomDialog()) {
                    if (code == Constant.STATUS_CODE_PAYMENT_SUCCESS) {
                        reqPaymentPass("OK");
                        new CheckPaymentStatusTask(StoreKonfirmasiActivity.this, invoiceModel.invoiceID, new Handler(){
                            @Override
                    ...
                    if (isDefaultLayout) {
                        if (code == Constant.STATUS_CODE_PAYMENT_SUCCESS) {
                            reqPaymentPass("OK");
                            new CheckPaymentStatusTask(StoreKonfirmasiActivity.this, invoiceModel.invoiceID, null).execute();
                        } else {
                            reqPaymentPass("NOK");
