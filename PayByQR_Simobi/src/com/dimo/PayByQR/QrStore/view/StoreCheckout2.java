...
public class StoreCheckout2 extends DIMOBaseActivity {
    ...
    private LinearLayout layoutPickupMethodChoices, layoutPickupMethodAddress, layoutPickupMethodStore, layoutChooseCity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutChooseCity = (LinearLayout) findViewById(R.id.checkout_pickup_method_address_choose_city_layout);
        ...
        spinnerStore.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        layoutPickupMethodStore.setBackgroundResource(R.drawable.background_store_edittext);
                        if (position == 0) {
    ...
    private void upDateTotalAfterShipping(int visibility) {
        txtShippingFee.setText(getString(R.string.text_detail_currency)+" "+DIMOUtils.formatAmount(Integer.toString(shippingFee)));
        layoutChooseCity.setBackgroundResource(R.drawable.background_store_edittext);
    ...
    private void getShippingFee() {
        String strJson = QrStoreUtil.getStringJson(cartData.carts, sharedPreferences.getString(QrStoreDefine.SHARED_PREF_CUST_NAME, ""),
                ...
                pickupContentID, sharedPreferences.getString(QrStoreDefine.SHARED_PREF_CUST_PHONE, ""),
    ...
    private void submitForm() {
        editAddress.setBackgroundResource(R.drawable.background_store_edittext);
        layoutChooseCity.setBackgroundResource(R.drawable.background_store_edittext);
        layoutPickupMethodStore.setBackgroundResource(R.drawable.background_store_edittext);
        if(selectedPickupMethodID.equals(PICKUP_METHODE_ADDR) && editAddress.getText().length() == 0) {
            editAddress.setBackgroundResource(R.drawable.background_store_edittext_error);
            ...
            layoutChooseCity.setBackgroundResource(R.drawable.background_store_edittext_error);
            ...
            layoutPickupMethodStore.setBackgroundResource(R.drawable.background_store_edittext_error);
