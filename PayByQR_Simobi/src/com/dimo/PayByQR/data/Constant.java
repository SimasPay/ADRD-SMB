...
public class Constant {
    ...
    public static final int ERROR_CODE_INVALID_GOODS        = 18;
    public static final int ERROR_CODE_OUT_OF_STOCK         = 19;
    ...
    public static final int ACTIVITY_RESULT_QRSTORE_CHECKOUT_ERROR  = 105;
    public static final int PERMISSIONS_REQUEST_STORAGE             = 106;
    public static final int PERMISSIONS_REQUEST_ALL                 = 107;
    ...
    public static final String INTENT_EXTRA_CUSTOM_DIALOG_LOYALTY   = "com.dimo.PayByQR.intent.extra.customDialogLoyalty";
    ...
    public static final String INTENT_EXTRA_NOTIFY_LAYOUT           = "com.dimo.PayByQR.intent.extra.notifyLayout";
