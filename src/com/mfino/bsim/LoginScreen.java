...
public class LoginScreen extends Activity {
			...
			public void onClick(View arg0) {			
				...
				if(!networkCheck){
					...
					try {
						...
						System.out.println(module+">>KEYs>>"+exponent+">>Login>>"+loginPin.getText().toString().getBytes());
						String rsaKey=CryptoService.encryptWithPublicKey(module, exponent, loginPin.getText().toString().getBytes());
							...
							public void handleMessage(Message msg) {
								...
								if (responseXml != null) {
									...
									if (!(msgCode == 630)) {
										...
										System.out.println("Testing>>>mobile Number"+ mobi+settings.getString("pin", ""));
						            	...
						            	new_mdn=loginId.getText().toString();
						            	 ...
						            	 while (rs.moveToNext()) {
						            		// array.clear();
						            		 mdn_name = rs.getString(rs.getColumnIndex(DBHelper.CONTACTS_COLUMN_NAME));
						            	        array.add(mdn_name);
						             ...
						             if(array.size()!=0){
										 ...
										 if(array.contains(final_mdn)){
								            ...
								            //	SDKLinkFragmentActivity.resetUserSession();
								            	/*Log.e("check_mdn_name",mobileNumber+"else_outtttttt");
								            	if(new_mdn.startsWith("0")){
									            	Log.e("check_mdn_name+0",new_mdn);
												...
												//mydb.insertfalshiz("false", loginId.getText().toString());
									...
									//mydb.insertMdn(loginId.getText().toString());
						             ...
						             if(array.size()!=0){
										 if(array.contains(mobileNumber)){
								            	Log.e("check_mdn_name", mobileNumber+array.toString()+"iffffff_iff");
									...
									//}
										...
										/*if ("-1".equals(responseContainer.getAppUpdateURL())) {
											...
											Intent intent = new Intent(LoginScreen.this,Update.class);
											intent.putExtra("msg",valueContainer.getAppUpdateURL());
											intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
											startActivity(intent);
										}*/
	...
	private void getUserAPIKey() {
		...
		final WebServiceHttp webServiceHttp = new WebServiceHttp(
				valueContainer, LoginScreen.this);
