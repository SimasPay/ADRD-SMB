...
public class ConfirmAddReceiver extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (bundle.getString("TRANSFER_TYPE").equals("toSmartFren")) {
			...
			try {
				if (bundle.getString("DEST_NUMBER").toString().equalsIgnoreCase("null")|| bundle.getString("DEST_NUMBER").length() <= 0) {
					destNumLayout.setVisibility(View.GONE);
				} else {
		...
		btn_confirm.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (selectedLanguage.equalsIgnoreCase("ENG")) {
					dialog = ProgressDialog.show(ConfirmAddReceiver.this, "  Banksinarmas               ",getResources().getString(R.string.eng_loading), true);

				} else {
					dialog = ProgressDialog.show(ConfirmAddReceiver.this, "  Banksinarmas               ",getResources().getString(R.string.bahasa_loading) , true);
				}
