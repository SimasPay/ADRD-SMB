...
public class ToOtherBankDetails extends Activity {
		...
		btn_ok.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if(!networkCheck){
					...
					if (selectedLanguage.equalsIgnoreCase("ENG")) {
						dialog = ProgressDialog.show(ToOtherBankDetails.this, "  Banksinarmas               ",getResources().getString(R.string.eng_loading), true);

					} else {
						dialog = ProgressDialog.show(ToOtherBankDetails.this, "  Banksinarmas               ",getResources().getString(R.string.bahasa_loading) , true);
					}
